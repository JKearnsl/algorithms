...
from src.views.widgets.matrix import Matrix
...
from src.views.widgets.tool_button import ToolButton
from src.views.widgets.widget import Widget
...
class WidgetsFactory:
    ...
    def modal(self, parent: QWidgetLike) -> Dialog:
        return Dialog(
    ...
    def tool_button(self, icon: QIcon = None,  *, parent: QWidgetLike = None) -> ToolButton:
        btn = ToolButton(self.theme.hover, self.theme.text_primary, parent)
        if icon:
            btn.setIcon(icon)
        return btn
    ...
    def widget(self, parent: QWidgetLike = None) -> Widget:
        return Widget(
            hover_color=self.theme.hover,
            parent=parent
        )