...
class Dialog(QDialog):
    ...
    def __init__(
        ...
        while True:
            if (new_parent := self.root_parent.parent()) is not None:
                self.root_parent = new_parent
                continue
            break

        self.root_parent.setDisabled(True)
    ...
    def on_close(self, a0):
        self.root_parent.setDisabled(False)
